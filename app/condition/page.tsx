                  ...
                  {loading ? (
                    ...
                    <div style={{ overflowX: 'auto' }}>
                      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <thead>
                          <tr>
                            <th style={th}>변경일자</th><th style={th}>구분</th><th style={th}>모드</th><th style={th}>단위</th>
                            {(holders as any[]).map(h => <th key={h} style={{ ...th, textAlign: 'center' }}>홀더 {h}</th>)}
                            <th style={th}>비고</th>
                          </tr>
                        </thead>
                        <tbody>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                      ...
                      <tbody>{data.map((r, i) => (
                        <tr key={i}>
                          ...
                          <td style={td}>{r.category}</td><td style={td}>{r.mode}</td><td style={td}>{r.unit}</td>
