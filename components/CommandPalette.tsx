...
export default function CommandPalette() {
  ...
  const commands: Command[] = [
    ...
    { id: 'scratch', title: 'Scratch', desc: '찍힘 관리', icon: '🔍', category: '페이지', href: '/scratch', keywords: ['찍힘', '스크래치'] },
    { id: 'imarking', title: 'i-Marking', desc: '아이마킹', icon: '📊', category: '페이지', href: '/imarking', keywords: ['아이마킹', 'imarking'] },
